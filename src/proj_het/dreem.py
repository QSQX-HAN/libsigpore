...
sys.path.append("%s/dreem/code" % thisdir)
...
class DREEM(object):
    ...
    def __init__(self, p_sid, input_file, input_dir, output_dir, outplot_dir,
        ...
        self.input_file = input_file  # dreem compatible file
    ...
    def fit(self):
        ...
        """
        X = EM_Files.Load_BitVectors(self.input_file, self.INFO_THRESH, self.SIG_THRESH, self.BV_THRESH,
                                     self.inc_TG, self.output_dir)
